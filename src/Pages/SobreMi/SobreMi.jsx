...
const SobreMi = () => {
  return (
    <div style={{ marginTop: "100px", padding: "0 20px", boxSizing: "border-box", width: "100%", display: "flex", flexDirection: "column", alignItems: "center" }}>
      <h3 className='mainbox' style={{ fontSize: "2rem", fontStyle: "italic", color: "#F39F5A", textAlign: "center", marginBottom: "10px" }}>
        "El arte de la comunicación es el lenguaje del liderazgo"
      </h3>
      <h4 className='mainbox' style={{ fontSize: "1rem", color: "#F39F5A", textAlign: "right", marginBottom: "20px" }}>
        James Humes
      </h4>
